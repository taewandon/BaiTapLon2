...
namespace PTUD_với_CSDL
{
    public partial class Chung_chi : Form
    {
        ...
        {
            DGV_NhanVien.DataSource = data.table("Select manv, tenchungchi, ngaycap From NhanVien_ChungChi inner join ChungChi on NhanVien_ChungChi.machungchi = ChungChi.machungchi");
